export default function ConvoList() {
    ...
    return (
        <div className="border-end border-white w-20 px-1 py-0 overflow-auto">
            <h3 className="text-white px-4 py-2 sticky-top bg-dark">Conversation</h3>
            <ul className="list-group list-group-flush mt-3">
                <li className="list-group-item d-flex justify-content-between align-items-start bg-dark text-white py-4">
                    ...
                    <div className="fw-bold me-3">Name of the friend</div>
                    </div>
